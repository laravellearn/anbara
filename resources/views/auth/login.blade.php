...
<head>
    ...
    <title>ورود - سامانه جامع انبارا</title>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('login.post') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="remember-me"> به خاطر بسپار </label>
                            </div>
                        </div>
                        <button class="btn btn-primary d-grid w-100">ورود</button>
                        <a href="{{ route('login.otp.request') }}" class="btn btn-label-secondary w-100 mt-2">
