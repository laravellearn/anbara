...
<head>
    ...
    <title>سامانه جامع انبارا - صفحه پیدا نشد | 404</title>
        ...
        <div class="authentication-inner py-4">
            ...
            <div style="text-align:center;margin:20px 0 5px;">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="mb-4">
                        <i class="bx bx-error-circle" style="font-size:64px;color:#ffab00"></i>
                    </div>

                    <h1 class="fw-bold mb-2">404</h1>

                    <h4 class="mb-2">صفحه مورد نظر یافت نشد</h4>
                    ...
                    <div class="d-flex justify-content-center gap-2">
                        ...
                        <a href="{{ route('dashboard.index') }}" class="btn btn-outline-secondary">صفحه اصلی</a>
                    </div>
