            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-4 p-sm-5">
                ...
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <button id="resend-btn" class="btn btn-label-secondary w-100 d-none" onclick="resendOtp()">
    ...
    <script>
        ...
        function resendOtp() {
            ...
            fetch("{{ route('login.otp.resend') }}", {
                ...
                .then(data => {
                    if (data.success) {
                        alert(data.message); // یا نمایش پیام زیباتر
                        location.reload(); // صفحه رفرش شود تا تایمر جدید شروع شود
                    } else {
                        alert(data.message);
                    }
                })
