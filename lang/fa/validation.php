...
return [
    ...
    'attributes' => [
        ...
        'new confirm password' => 'تکرار رمز عبور',
    ...
    'password' => [
        ...
        'mixed' => 'رمز عبور باید شامل حروف بزرگ و کوچک انگلیسی باشد.',
        'numbers' => 'رمز عبور باید شامل حداقل یک عدد باشد.',
        'symbols' => 'رمز عبور باید شامل حداقل یک کاراکتر خاص باشد.',
        'uncompromised' => 'رمز عبور انتخاب شده ناامن است.',
    ],
    'validation.confirmed' => 'تکرار رمز عبور تطابق ندارد',
