    ...
    <div class="card shadow-none border">
        <div class="card-body">
            <div class="d-flex align-items-start justify-content-between">
                ...
                <span class="badge bg-label-primary rounded p-2"><i class="bx bx-category bx-sm"></i></span>
            </div>
        </div>
    </div>
</div>
...
<div class="col-sm-6 col-xl-3">
    <div class="card shadow-none border">
        <div class="card-body">
            <div class="d-flex align-items-start justify-content-between">
                <div class="content-left">
                    <span class="fw-medium text-muted">زیرمجموعه‌ها</span>
                    <h3 class="mb-0 mt-1">{{ $stats['has_children'] }}</h3>
                </div>
