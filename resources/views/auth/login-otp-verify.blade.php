...
<head>
    ...
    <style>
        .otp-input { width: 55px !important; height: 55px !important; text-align: center; font-size: 22px; font-weight: bold; }
        .countdown { font-size: 15px; font-weight: 600; }
    </style>
</head>
<body>
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-4 p-sm-5">
                <div class="w-px-400 mx-auto">
                    ...
                    <p class="mb-4" style="text-align:center">
                        ...
                        را وارد کنید.
                        <br>
                        <a href="{{ route('login.otp.request') }}" style="text-align: center">ویرایش شماره</a>
                    ...
                    <form action="{{ route('login.otp.verify') }}" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100">تایید موبایل</button>
                    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ===== مقداردهی امن =====
            @php
                $ts = isset($expiresAt) ? $expiresAt->timestamp : 0;
            @endphp
            let expiresAt = {{ $ts }};
            ...
            inputs.forEach((input, index) => {
                ...
                input.addEventListener('paste', function(e) {
                    ...
                    inputs.forEach((item, i) => { item.value = pastedText[i] ?? ''; });
            ...
            function startTimer() {
                ...
                // فقط اگر هنوز زمان باقی باشد interval را تنظیم کن
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        if (isNaN(newExpiresAt) || newExpiresAt <= 0) {
                            showAlert('زمان بازگشتی نامعتبر است.', 'danger');
