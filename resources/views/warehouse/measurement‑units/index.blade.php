...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row g-4 mb-4" id="statsCards">
        @include('warehouse.measurement-units._stats', ['stats' => $stats])
    </div>
            ...
            <div class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="liveSearch" class="form-control" placeholder="عنوان یا نماد..." autocomplete="off">
    ...
    <div class="card shadow-none border">
        <div class="card-header border-bottom d-flex flex-wrap justify-content-between align-items-center gap-3">
            <h5 class="card-title mb-0">
                <i class="bx bx-ruler me-1"></i> واحدهای اندازه‌گیری
...
@push('scripts')
<script>
    // همان اسکریپت جستجوی زنده با شناسه‌های مناسب
    $(function(){
        let searchTimeout;
        ...
        function performSearch() {
            ...
            $.ajax({
                url: '{{ route('warehouse.measurement-units.index') }}',
